  ...
  const sections: Section[] = [
    ...
    },
    {
      ...
      rows: [
        ...
        { name: "boom (audio enhancement)", trigger: "boom", typed: true, note: "macOS only. Enter → system-wide EQ (10-band), genre/device presets, enhancement effects & volume boost in the preview. Driverless (Core-Audio process taps, macOS 14.2+). Esc closes." },
