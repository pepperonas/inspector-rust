...
<div align="center">
  ...
  *Grob sortiert nach Alltagsnutzen × Engineering-Aufwand dahinter — Flagship-Features zuerst, Easter-Eggs zuletzt.*
  ...
  Tauri 2 (WebView2 / WKWebView) · Rust-Workspace (`core/rust-lib` geteilt, 2-Zeilen-Per-OS-Bundle-Shells) · React 19 + TypeScript 5 + Tailwind v4 + Vite 7 · Helligkeit via CoreGraphics/GDI-Gamma + DDC/CI (`ddc-hi`). **2470 Unit-Tests (978 Rust + 1492 Frontend).** MIT-lizenziert.
  ...
  <p>
    <a href="https://github.com/pepperonas/inspector-rust" title="Codezeilen (Rust + TypeScript Quellcode)">
      <img src="https://img.shields.io/badge/lines%20of%20code-~85k-2b3137?style=for-the-badge&logo=rust&logoColor=white" height="64" alt="Lines of code" />
    </a>
    &nbsp;
    <a href="https://github.com/pepperonas/inspector-rust/actions/workflows/ci.yml" title="Unit-Tests — 978 Rust + 1492 Frontend, alle grün">
      <img src="https://img.shields.io/badge/unit%20tests-2470%20passing-2ea043?style=for-the-badge&logo=vitest&logoColor=white" height="64" alt="Unit tests" />
    </a>
  </p>
  ...
  [![Unit tests](https://img.shields.io/badge/unit%20tests-2470%20(978%20Rust%20%2B%201492%20TS)-success?style=flat-square)](https://github.com/pepperonas/inspector-rust/actions/workflows/ci.yml)
  ...
  [![cargo test](https://img.shields.io/badge/cargo%20test-978%20passing-success?style=flat-square&logo=rust&logoColor=white)](#)
  ...
  <!-- ── Features (numerical) ────────────────────────────────── -->
  [![Tests](https://img.shields.io/badge/tests-2470%20passing-success?style=flat-square)](#)
...
cargo test --workspace  # Rust-Unit-Tests — 978 Tests
```
