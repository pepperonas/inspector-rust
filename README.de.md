...
<div align="center">
  ...
  *Grob sortiert nach Alltagsnutzen × Engineering-Aufwand dahinter — Flagship-Features zuerst, Easter-Eggs zuletzt.*
  ...
  Tauri 2 (WebView2 / WKWebView) · Rust-Workspace (`core/rust-lib` geteilt, 2-Zeilen-Per-OS-Bundle-Shells) · React 19 + TypeScript 5 + Tailwind v4 + Vite 7 · Helligkeit via CoreGraphics/GDI-Gamma + DDC/CI (`ddc-hi`). **4336 Unit-Tests (1634 Rust + 2702 Frontend).** MIT-lizenziert.
  ...
  <p>
    ...
    &nbsp;
    <a href="https://github.com/pepperonas/inspector-rust/actions/workflows/ci.yml" title="Unit-Tests — 1634 Rust + 2702 Frontend, alle grün">
...
| **`repo`** — Git-Historie auf einen Blick, als eine HTML-Datei exportierbar | **`clock`** — Weltzeituhr; jede IANA-Zone, Sommerzeit macht das OS |
...
| `repo` <sub>(alias: `export`)</sub> | v0.123.0 | Git-Repo-Statistik — Commits, Mitwirkende, Hotspots. |
...
| `btsniff` <sub>(alias: `btcap`, `btcapture`, `blecap`)</sub> | v0.179.0 | Bluetooth-Capture analysieren — HCI/ATT/GATT dekodieren, Byte-Diff zum Reversen. |
