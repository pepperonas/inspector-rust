...
<div align="center">
  ...
  *Roughly sorted by everyday usefulness × how much engineering sits behind it — flagship features first, easter eggs last.*
  ...
  Tauri 2 (WebView2 / WKWebView) · Rust workspace (`core/rust-lib` shared, 2-line per-OS bundle shells) · React 19 + TypeScript 5 + Tailwind v4 + Vite 7 · brightness via CoreGraphics/GDI gamma + DDC/CI (`ddc-hi`). **4563 unit tests (1745 Rust + 2818 frontend).** MIT-licensed.
  ...
  <p>
    <a href="https://github.com/pepperonas/inspector-rust" title="Lines of code (Rust + TypeScript source)">
      <img src="https://img.shields.io/badge/lines%20of%20code-~185k-2b3137?style=for-the-badge&logo=rust&logoColor=white" height="64" alt="Lines of code" />
    </a>
    &nbsp;
    <a href="https://github.com/pepperonas/inspector-rust/actions/workflows/ci.yml" title="Unit tests — 1745 Rust + 2818 frontend, all passing">
      <img src="https://img.shields.io/badge/unit%20tests-4563%20passing-2ea043?style=for-the-badge&logo=vitest&logoColor=white" height="64" alt="Unit tests" />
    </a>
  </p>
  ...
  [![Unit tests](https://img.shields.io/badge/unit%20tests-4563%20(1745%20Rust%20%2B%202818%20TS)-success?style=flat-square)](https://github.com/pepperonas/inspector-rust/actions/workflows/ci.yml)
  ...
  [![IPC commands](https://img.shields.io/badge/IPC%20commands-undefined-7c3aed?style=flat-square&logo=tauri&logoColor=white)](./core/rust-lib/src/lib.rs)
  [![UI components](https://img.shields.io/badge/UI%20components-undefined-61DAFB?style=flat-square&logo=react&logoColor=black)](./core/frontend/src/components)
  [![Test suites](https://img.shields.io/badge/test%20suites-undefined-2ea043?style=flat-square&logo=vitest&logoColor=white)](#testing)
  ...
  [![cargo test](https://img.shields.io/badge/cargo%20test-1745%20passing-success?style=flat-square&logo=rust&logoColor=white)](#)
  [![vitest](https://img.shields.io/badge/vitest-2818%20passing-success?style=flat-square&logo=vitest&logoColor=white)](#)
  ...
  <!-- ── Features (numerical) ────────────────────────────────── -->
  [![Tests](https://img.shields.io/badge/tests-4563%20passing-success?style=flat-square)](#)
  [![IPC commands](https://img.shields.io/badge/IPC%20commands-undefined-blueviolet?style=flat-square)](./core/rust-lib/src/commands.rs)
  ...
  [![Tauri events](https://img.shields.io/badge/events-undefined-blueviolet?style=flat-square)](#)
  [![Rust modules](https://img.shields.io/badge/Rust%20modules-97-CE422B?style=flat-square&logo=rust&logoColor=white)](./core/rust-lib/src)
  ...
  [![DB tables](https://img.shields.io/badge/SQLite%20tables-undefined-003B57?style=flat-square&logo=sqlite&logoColor=white)](./docs/encryption.md)
  ...
  [![Rust LoC](https://img.shields.io/badge/Rust-~95k%20LoC-CE422B?style=flat-square&logo=rust&logoColor=white)](./core/rust-lib/src)
  [![TS LoC](https://img.shields.io/badge/TypeScript-~90k%20LoC-3178C6?style=flat-square&logo=typescript&logoColor=white)](./core/frontend/src)
...
| **`repo`** — git + GitHub activity (24 h / 7 d, ranges, heatmap, hotspots), HTML/PDF export, ⌘K clone | **`clock`** — world clock; any IANA zone, DST handled by the OS |
...
| `repo` <sub>(alias: `export`)</sub> | v0.123.0 | Git repo stats + clone — paste a GitHub URL, get ranges, heatmap, hotspots, bus factor. |
...
| `dezibel` <sub>(alias: `db`)</sub> | v0.154.0 | Live microphone loudness in dB (SPL estimate), animated in the preview. |
| `bluetooth` <sub>(alias: `bt`)</sub> | v0.159.0 | Manage Bluetooth devices — connect, disconnect, unpair. |
| `ip` | v0.172.0 | Show your public IP, approximate location, network and a map. |
| `lumen` | v0.175.0 | Live ambient-light reading in lux, when the device exposes a sensor. |
| `btsniff` <sub>(alias: `btcap`, `btcapture`, `blecap`)</sub> | v0.179.0 | Bluetooth protocol analyzer — live BLE scan + import/decode captures, byte-diff. |
| `mailcheck` <sub>(alias: `emailcheck`, `mailverify`, `mxcheck`)</sub> | v0.181.0 | Check e-mail deliverability — syntax, DNS/MX, and a non-invasive SMTP probe. |
...
```bash
pnpm test               # frontend unit tests (vitest + happy-dom) — 2818 tests
cargo test --workspace  # Rust unit tests — 1745 tests
```
...
| [bluetooth-capture.md](./docs/bluetooth-capture.md) | `btsniff` — Bluetooth capture analyzer (HCI/ATT/GATT decode + byte-diff) |
| [mailcheck.md](./docs/mailcheck.md) | `mailcheck` — layered e-mail deliverability (syntax · DNS/MX · non-invasive SMTP) |
...
Inspector Rust bundles, in one free MIT-licensed app, what is normally sold as a shelf of separate utilities. The well-known equivalent per feature, at official list prices (September 2026, rounded — several vendors price regionally or run permanent sales):

| Inspector Rust feature | Replaces | Price (USD) |
|---|---|---|
| Clipboard history (pins, notes, lineage) | [Paste](https://pasteapp.io/pricing) | $29.99/yr |
| Launcher, command palette, calculator | [Alfred 5 Powerpack](https://www.alfredapp.com/shop/) | £34 ≈ $43 |
| Text expander (auto-expansion, snippets) | [TextExpander](https://textexpander.com/pricing) | $60/yr |
| Window snapping + layout palette | [Moom](https://manytricks.com/moom/) | $15 |
| Monitor brightness | [Lunar Pro](https://lunar.fyi/) | $23 |
| EDR brightness past 100 % | [Vivid](https://getvivid.app/) | €10 ≈ $11 |
| System-wide EQ + volume boost (`boom`) | [Boom 3D](https://apps.apple.com/us/app/boom-3d-volume-booster-eq/id1233048948) | $49.99 |
| Audio output switching + routing (`sound`) | [SoundSource](https://rogueamoeba.com/soundsource/buy.php) | $49 |
| Screenshots, annotation, pins, screen recording | [CleanShot X](https://cleanshot.com/pricing) | $35 |
| Screen OCR | [TextSniper](https://textsniper.app/) | $7.99 |
| Color eyedropper + loupe | [Sip](https://sipapp.io/) | $29.99 |
| System cleaner (`clean`)¹ | [CleanMyMac](https://macpaw.com/cleanmymac) | ~$39.95/yr |
| System monitor + history (`stats`) | [iStat Menus 7](https://apps.apple.com/us/app/istat-menus-7/id6499559693) | $11.99 |
| Automatic time tracking (Timesheet) | [Timing Professional](https://timingapp.com/) | $108/yr |
| Video download (`social`) | [Downie](https://software.charliemonroe.net/downie/) | $19.99 |
| Media trim + audio swap | [Permute](https://software.charliemonroe.net/permute/) | $14.99 |
| Trackpad gestures | [BetterTouchTool](https://folivora.ai/buy) | $15 |
| Disk-usage sunburst (`disk`) | [DaisyDisk](https://daisydiskapp.com/) | $9.99 |
| Network monitor + world map (`snitch`)² | [Little Snitch 6](https://obdev.at/products/littlesnitch/order.html) | $59 |
| Bluetooth device menu (`bt`) | [ToothFairy](https://apps.apple.com/us/app/toothfairy/id1191449274) | $6.99 |
| Markdown → PDF | [Marked 2](https://apps.apple.com/us/app/marked-2-markdown-preview/id890031187) | $13.99 |
| 2FA / TOTP codes | [Step Two](https://apps.apple.com/us/app/step-two/id1448916662) (unlock) | $9.99 |

**That's roughly $426 in one-time purchases plus about $238 every year in subscriptions — Inspector Rust: $0.**

Plus the categories where the popular equivalents are already free (Amphetamine for keep-awake, Shazam, Espanso, Maccy, …) — here they simply live in the same search bar.

¹ The cache/log/duplicates part — CleanMyMac's malware/uninstaller modules have no counterpart here.
² Monitor, per-app activity and the live world map — the blocker is best-effort by design; a self-signed app cannot ship a NetworkExtension firewall, so Little Snitch's enforcement layer genuinely isn't replaced.

No feature parity claim with any of these — each of them goes deeper in its niche. But these are the tools this app replaces in everyday use.
