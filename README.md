...
<div align="center">
  ...
  *Roughly sorted by everyday usefulness × how much engineering sits behind it — flagship features first, easter eggs last.*
  ...
  Tauri 2 (WebView2 / WKWebView) · Rust workspace (`core/rust-lib` shared, 2-line per-OS bundle shells) · React 19 + TypeScript 5 + Tailwind v4 + Vite 7 · brightness via CoreGraphics/GDI gamma + DDC/CI (`ddc-hi`). **4356 unit tests (1648 Rust + 2708 frontend).** MIT-licensed.
  ...
  <p>
    ...
    &nbsp;
    <a href="https://github.com/pepperonas/inspector-rust/actions/workflows/ci.yml" title="Unit tests — 1648 Rust + 2708 frontend, all passing">
      <img src="https://img.shields.io/badge/unit%20tests-4356%20passing-2ea043?style=for-the-badge&logo=vitest&logoColor=white" height="64" alt="Unit tests" />
    </a>
  </p>
  ...
  [![Unit tests](https://img.shields.io/badge/unit%20tests-4356%20(1648%20Rust%20%2B%202708%20TS)-success?style=flat-square)](https://github.com/pepperonas/inspector-rust/actions/workflows/ci.yml)
  ...
  [![Commands](https://img.shields.io/badge/commands-65-4f46e5?style=flat-square)](#commands)
  [![Docs](https://img.shields.io/badge/docs-26%20pages-0ea5e9?style=flat-square)](./docs)
  [![Rust modules](https://img.shields.io/badge/rust%20modules-92-CE422B?style=flat-square&logo=rust&logoColor=white)](./core/rust-lib/src)
  ...
  [![cargo test](https://img.shields.io/badge/cargo%20test-1648%20passing-success?style=flat-square&logo=rust&logoColor=white)](#)
  [![vitest](https://img.shields.io/badge/vitest-2708%20passing-success?style=flat-square&logo=vitest&logoColor=white)](#)
  ...
  <!-- ── Features (numerical) ────────────────────────────────── -->
  [![Tests](https://img.shields.io/badge/tests-4356%20passing-success?style=flat-square)](#)
  ...
  [![Rust LoC](https://img.shields.io/badge/Rust-~98k%20LoC-CE422B?style=flat-square&logo=rust&logoColor=white)](./core/rust-lib/src)
  ...
  [![Features](https://img.shields.io/badge/features-183-0ea5e9?style=flat-square)](./features.txt)
  ...
  [![100+ features](https://img.shields.io/badge/features-183%2B-e11d48?style=flat-square)](./features.txt)
...
```bash
pnpm test               # frontend unit tests (vitest + happy-dom) — 2708 tests
cargo test --workspace  # Rust unit tests — 1648 tests
```
