...
<div align="center">
  ...
  *Grob sortiert nach Alltagsnutzen × Engineering-Aufwand dahinter — Flagship-Features zuerst, Easter-Eggs zuletzt.*
  ...
  Tauri 2 (WebView2 / WKWebView) · Rust-Workspace (`core/rust-lib` geteilt, 2-Zeilen-Per-OS-Bundle-Shells) · React 19 + TypeScript 5 + Tailwind v4 + Vite 7 · Helligkeit via CoreGraphics/GDI-Gamma + DDC/CI (`ddc-hi`). **4219 Unit-Tests (1583 Rust + 2636 Frontend).** MIT-lizenziert.
  ...
  <p>
    ...
    &nbsp;
    <a href="https://github.com/pepperonas/inspector-rust/actions/workflows/ci.yml" title="Unit-Tests — 1583 Rust + 2636 Frontend, alle grün">
      <img src="https://img.shields.io/badge/unit%20tests-4219%20passing-2ea043?style=for-the-badge&logo=vitest&logoColor=white" height="64" alt="Unit tests" />
    </a>
  </p>
  ...
  [![Unit tests](https://img.shields.io/badge/unit%20tests-4219%20(1583%20Rust%20%2B%202636%20TS)-success?style=flat-square)](https://github.com/pepperonas/inspector-rust/actions/workflows/ci.yml)
  ...
  [![cargo test](https://img.shields.io/badge/cargo%20test-1583%20passing-success?style=flat-square&logo=rust&logoColor=white)](#)
  [![vitest](https://img.shields.io/badge/vitest-2636%20passing-success?style=flat-square&logo=vitest&logoColor=white)](#)
  ...
  <!-- ── Features (numerical) ────────────────────────────────── -->
  [![Tests](https://img.shields.io/badge/tests-4219%20passing-success?style=flat-square)](#)
  ...
  [![Features](https://img.shields.io/badge/features-177-0ea5e9?style=flat-square)](./features.txt)
  ...
  [![100+ Features](https://img.shields.io/badge/features-177%2B-e11d48?style=flat-square)](./features.txt)
...
```bash
pnpm test               # Frontend-Unit-Tests (vitest + happy-dom) — 2636 Tests
cargo test --workspace  # Rust-Unit-Tests — 1583 Tests
```
