...
<div align="center">
  ...
  *Grob sortiert nach Alltagsnutzen × Engineering-Aufwand dahinter — Flagship-Features zuerst, Easter-Eggs zuletzt.*
  ...
  Tauri 2 (WebView2 / WKWebView) · Rust-Workspace (`core/rust-lib` geteilt, 2-Zeilen-Per-OS-Bundle-Shells) · React 19 + TypeScript 5 + Tailwind v4 + Vite 7 · Helligkeit via CoreGraphics/GDI-Gamma + DDC/CI (`ddc-hi`). **3954 Unit-Tests (1493 Rust + 2461 Frontend).** MIT-lizenziert.
  ...
  <p>
    ...
    &nbsp;
    <a href="https://github.com/pepperonas/inspector-rust/actions/workflows/ci.yml" title="Unit-Tests — 1493 Rust + 2461 Frontend, alle grün">
      <img src="https://img.shields.io/badge/unit%20tests-3954%20passing-2ea043?style=for-the-badge&logo=vitest&logoColor=white" height="64" alt="Unit tests" />
    </a>
  </p>
  ...
  [![Unit tests](https://img.shields.io/badge/unit%20tests-3954%20(1493%20Rust%20%2B%202461%20TS)-success?style=flat-square)](https://github.com/pepperonas/inspector-rust/actions/workflows/ci.yml)
  ...
  [![cargo test](https://img.shields.io/badge/cargo%20test-1493%20passing-success?style=flat-square&logo=rust&logoColor=white)](#)
  ...
  <!-- ── Features (numerical) ────────────────────────────────── -->
  [![Tests](https://img.shields.io/badge/tests-3954%20passing-success?style=flat-square)](#)
...
cargo test --workspace  # Rust-Unit-Tests — 1493 Tests
```
