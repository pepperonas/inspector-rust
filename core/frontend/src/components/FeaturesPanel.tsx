  ...
  const sections: Section[] = [
    ...
    },
    {
      ...
      rows: [
        ...
        { name: "Song recognition (shazam)", trigger: "shazam", typed: true, note: "Enter → records ~10 s from the mic, generates a Shazam audio-fingerprint and identifies the song: cover, title, artist, album, genre, year + a link to open it in Shazam. R = listen again, Esc closes. Needs microphone access." },
