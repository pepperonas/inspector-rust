  ...
  return (
    ...
    >
      ...
      <button
        ...
        className="ml-auto flex items-center gap-1 rounded-lg border border-[var(--color-border)] px-2.5 py-1.5 text-[12px] font-medium hover:bg-[var(--color-bg)] disabled:opacity-60"
      >
