...
<div align="center">
  ...
  *Roughly sorted by everyday usefulness × how much engineering sits behind it — flagship features first, easter eggs last.*
  ...
  Tauri 2 (WebView2 / WKWebView) · Rust workspace (`core/rust-lib` shared, 2-line per-OS bundle shells) · React 19 + TypeScript 5 + Tailwind v4 + Vite 7 · brightness via CoreGraphics/GDI gamma + DDC/CI (`ddc-hi`). **4253 unit tests (1590 Rust + 2663 frontend).** MIT-licensed.
  ...
  <p>
    <a href="https://github.com/pepperonas/inspector-rust" title="Lines of code (Rust + TypeScript source)">
      <img src="https://img.shields.io/badge/lines%20of%20code-~173k-2b3137?style=for-the-badge&logo=rust&logoColor=white" height="64" alt="Lines of code" />
    </a>
    &nbsp;
    <a href="https://github.com/pepperonas/inspector-rust/actions/workflows/ci.yml" title="Unit tests — 1590 Rust + 2663 frontend, all passing">
      <img src="https://img.shields.io/badge/unit%20tests-4253%20passing-2ea043?style=for-the-badge&logo=vitest&logoColor=white" height="64" alt="Unit tests" />
    </a>
  </p>
  ...
  [![Unit tests](https://img.shields.io/badge/unit%20tests-4253%20(1590%20Rust%20%2B%202663%20TS)-success?style=flat-square)](https://github.com/pepperonas/inspector-rust/actions/workflows/ci.yml)
  ...
  [![Commands](https://img.shields.io/badge/commands-64-4f46e5?style=flat-square)](#commands)
  ...
  [![cargo test](https://img.shields.io/badge/cargo%20test-1590%20passing-success?style=flat-square&logo=rust&logoColor=white)](#)
  [![vitest](https://img.shields.io/badge/vitest-2663%20passing-success?style=flat-square&logo=vitest&logoColor=white)](#)
  ...
  <!-- ── Features (numerical) ────────────────────────────────── -->
  [![Tests](https://img.shields.io/badge/tests-4253%20passing-success?style=flat-square)](#)
  ...
  [![Rust LoC](https://img.shields.io/badge/Rust-~87k%20LoC-CE422B?style=flat-square&logo=rust&logoColor=white)](./core/rust-lib/src)
  [![TS LoC](https://img.shields.io/badge/TypeScript-~86k%20LoC-3178C6?style=flat-square&logo=typescript&logoColor=white)](./core/frontend/src)
  [![Features](https://img.shields.io/badge/features-182-0ea5e9?style=flat-square)](./features.txt)
  ...
  [![100+ features](https://img.shields.io/badge/features-182%2B-e11d48?style=flat-square)](./features.txt)
...
| `dezibel` <sub>(alias: `db`)</sub> | v0.154.0 | Live microphone loudness below full scale, animated in the preview. |
...
```bash
pnpm test               # frontend unit tests (vitest + happy-dom) — 2663 tests
cargo test --workspace  # Rust unit tests — 1590 tests
```
