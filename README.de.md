...
<div align="center">
  ...
  *Grob sortiert nach Alltagsnutzen × Engineering-Aufwand dahinter — Flagship-Features zuerst, Easter-Eggs zuletzt.*
  ...
  Tauri 2 (WebView2 / WKWebView) · Rust-Workspace (`core/rust-lib` geteilt, 2-Zeilen-Per-OS-Bundle-Shells) · React 19 + TypeScript 5 + Tailwind v4 + Vite 7 · Helligkeit via CoreGraphics/GDI-Gamma + DDC/CI (`ddc-hi`). **2695 Unit-Tests (1095 Rust + 1600 Frontend).** MIT-lizenziert.
  ...
  <p>
    ...
    &nbsp;
    <a href="https://github.com/pepperonas/inspector-rust/actions/workflows/ci.yml" title="Unit-Tests — 1095 Rust + 1600 Frontend, alle grün">
      <img src="https://img.shields.io/badge/unit%20tests-2695%20passing-2ea043?style=for-the-badge&logo=vitest&logoColor=white" height="64" alt="Unit tests" />
    </a>
  </p>
  ...
  [![Unit tests](https://img.shields.io/badge/unit%20tests-2695%20(1095%20Rust%20%2B%201600%20TS)-success?style=flat-square)](https://github.com/pepperonas/inspector-rust/actions/workflows/ci.yml)
  ...
  [![vitest](https://img.shields.io/badge/vitest-1600%20passing-success?style=flat-square&logo=vitest&logoColor=white)](#)
  ...
  <!-- ── Features (numerical) ────────────────────────────────── -->
  [![Tests](https://img.shields.io/badge/tests-2695%20passing-success?style=flat-square)](#)
...
```bash
pnpm test               # Frontend-Unit-Tests (vitest + happy-dom) — 1600 Tests
